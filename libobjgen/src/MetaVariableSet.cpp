...
MetaVariableSet::MetaVariableSet(
    ...
    : MetaVariable(), mElementType(elementType) {}

MetaVariableSet::~MetaVariableSet() {}

size_t MetaVariableSet::GetSize() const { return 0; }
...
std::string MetaVariableSet::GetType() const { return "set"; }

bool MetaVariableSet::IsCoreType() const { return false; }
...
uint16_t MetaVariableSet::GetDynamicSizeCount() const { return 1; }
...
std::string MetaVariableSet::GetConstructValue() const { return std::string(); }
...
std::string MetaVariableSet::GetLoadCode(const Generator& generator,
  ...
  if (mElementType && MetaObject::IsValidIdentifier(name) &&
    ...
    if (!code.empty()) {
      ...
      code = generator.ParseTemplate(0, "VariableSetLoad", replacements);
    }
  }
...
std::string MetaVariableSet::GetSaveCode(const Generator& generator,
  ...
  if (mElementType && MetaObject::IsValidIdentifier(name) &&
    ...
    if (!code.empty()) {
      ...
      code = generator.ParseTemplate(0, "VariableSetSave", replacements);
    }
  }
...
std::string MetaVariableSet::GetLoadRawCode(const Generator& generator,
  ...
  if (mElementType && MetaObject::IsValidIdentifier(name) &&
    ...
    if (!code.empty()) {
      ...
      code = generator.ParseTemplate(0, "VariableSetLoadRaw", replacements);
    }
  }
...
std::string MetaVariableSet::GetSaveRawCode(const Generator& generator,
  ...
  if (mElementType && MetaObject::IsValidIdentifier(name) &&
    ...
    if (!code.empty()) {
      ...
      code = generator.ParseTemplate(0, "VariableSetSaveRaw", replacements);
    }
  }
...
std::string MetaVariableSet::GetXmlLoadCode(const Generator& generator,
  ...
  if (mElementType) {
    ...
    code =
        generator.ParseTemplate(tabLevel, "VariableSetXmlLoad", replacements);
  }
...
std::string MetaVariableSet::GetXmlSaveCode(const Generator& generator,
  ...
  if (mElementType) {
    ...
    code = generator.ParseTemplate(0, "VariableSetXmlSave", replacements);
  }
...
std::string MetaVariableSet::GetAccessDeclarations(const Generator& generator,
  ...
  if (mElementType) {
    ...
    ss << generator.ParseTemplate(tabLevel, "VariableSetAccessDeclarations",
                                  replacements)
       << std::endl;
  }
...
std::string MetaVariableSet::GetAccessFunctions(const Generator& generator,
  ...
  if (mElementType) {
    ...
    ss << std::endl
       << generator.ParseTemplate(0, "VariableSetAccessFunctions", replacements)
       << std::endl;
  }
...
std::string MetaVariableSet::GetUtilityDeclarations(const Generator& generator,
  ...
  if (mElementType) {
    ...
    ss << generator.ParseTemplate(tabLevel, "VariableSetUtilityDeclarations",
                                  replacements)
       << std::endl;
  }
...
std::string MetaVariableSet::GetUtilityFunctions(
  ...
  if (mElementType) {
    ...
    ss << std::endl
       << generator.ParseTemplate(0, "VariableSetUtilityFunctions",
                                  replacements)
       << std::endl;
  }
...
std::string MetaVariableSet::GetAccessScriptBindings(const Generator& generator,
  ...
  if (mElementType) {
    ...
    ss << generator.ParseTemplate(tabLevel, "VariableSetAccessScriptBindings",
                                  replacements)
       << std::endl;
  }
...
void MetaVariableSet::GenerateSchema(GeneratorXmlSchema* pGenerator,
  ...
  pGenerator->GenerateMemberArrayType(pSequence, GetName(), elementType, 0,
                                      !mElementType->IsCoreType());
}

void MetaVariableSet::GenerateSchemaType(GeneratorXmlSchema* pGenerator,
                                         const std::string& parentObj,
