...
MetaVariableMap::MetaVariableMap(
    const std::shared_ptr<MetaVariable>& keyElementType,
    const std::shared_ptr<MetaVariable>& valueElementType)
    : MetaVariable(),
      mKeyElementType(keyElementType),
      mValueElementType(valueElementType) {}

MetaVariableMap::~MetaVariableMap() {}

size_t MetaVariableMap::GetSize() const { return 0; }
...
std::string MetaVariableMap::GetType() const { return "map"; }

bool MetaVariableMap::IsCoreType() const { return false; }
...
bool MetaVariableMap::IsValid() const {
  return mKeyElementType && mKeyElementType->IsValid() && mValueElementType &&
         mValueElementType->IsValid() && !IsLookupKey();
}

bool MetaVariableMap::Load(std::istream& stream) {
  MetaVariable::Load(stream);

  return mKeyElementType->Load(stream) && mValueElementType->Load(stream) &&
         IsValid();
}
...
bool MetaVariableMap::Save(std::ostream& stream) const {
  ...
  return IsValid() && mKeyElementType->Save(stream) &&
         mValueElementType->Save(stream);
}
...
uint16_t MetaVariableMap::GetDynamicSizeCount() const { return 1; }
...
std::string MetaVariableMap::GetConstructValue() const { return std::string(); }
...
std::string MetaVariableMap::GetValidCondition(const Generator& generator,
  ...
  if (mKeyElementType && mValueElementType) {
    std::string keyCode =
        mKeyElementType->GetValidCondition(generator, "value", recursive);
    std::string valueCode =
        mValueElementType->GetValidCondition(generator, "value", recursive);
    ...
    if (!keyCode.empty() && !valueCode.empty()) {
      ...
      code =
          generator.ParseTemplate(0, "VariableMapValidCondition", replacements);
    }
  }
...
std::string MetaVariableMap::GetLoadCode(const Generator& generator,
  ...
  if (mKeyElementType && mValueElementType &&
      MetaObject::IsValidIdentifier(name) &&
      MetaObject::IsValidIdentifier(stream)) {
    std::string keyCode =
        mKeyElementType->GetLoadCode(generator, "element", stream);
    std::string valueCode =
        mValueElementType->GetLoadCode(generator, "element", stream);
    ...
    if (!keyCode.empty() && !valueCode.empty()) {
      ...
      code = generator.ParseTemplate(0, "VariableMapLoad", replacements);
    }
  }
...
std::string MetaVariableMap::GetSaveCode(const Generator& generator,
  ...
  if (mKeyElementType && mValueElementType &&
      ...
      MetaObject::IsValidIdentifier(stream)) {
    std::string keyCode =
        mKeyElementType->GetSaveCode(generator, "element", stream);
    std::string valueCode =
        mValueElementType->GetSaveCode(generator, "element", stream);
    ...
    if (!keyCode.empty() && !valueCode.empty()) {
      ...
      code = generator.ParseTemplate(0, "VariableMapSave", replacements);
    }
  }
...
std::string MetaVariableMap::GetLoadRawCode(const Generator& generator,
  ...
  if (mKeyElementType && mValueElementType &&
      ...
      MetaObject::IsValidIdentifier(stream)) {
    std::string keyCode =
        mKeyElementType->GetLoadRawCode(generator, "element", stream);
    std::string valueCode =
        mValueElementType->GetLoadRawCode(generator, "element", stream);
    ...
    if (!keyCode.empty() && !valueCode.empty()) {
      ...
      code = generator.ParseTemplate(0, "VariableMapLoadRaw", replacements);
    }
  }
...
std::string MetaVariableMap::GetSaveRawCode(const Generator& generator,
  ...
  if (mKeyElementType && mValueElementType &&
      ...
      MetaObject::IsValidIdentifier(stream)) {
    std::string keyCode =
        mKeyElementType->GetSaveRawCode(generator, "element", stream);
    std::string valueCode =
        mValueElementType->GetSaveRawCode(generator, "element", stream);
    ...
    if (!keyCode.empty() && !valueCode.empty()) {
      ...
      code = generator.ParseTemplate(0, "VariableMapSaveRaw", replacements);
    }
  }
...
std::string MetaVariableMap::GetXmlLoadCode(const Generator& generator,
  ...
  if (mKeyElementType && mValueElementType) {
    std::string keyCode = mKeyElementType->GetXmlLoadCode(
        generator, generator.GetMemberName(mKeyElementType), doc, "keyNode",
        tabLevel + 1);
    std::string valueCode = mValueElementType->GetXmlLoadCode(
        generator, generator.GetMemberName(mValueElementType), doc, "valueNode",
        tabLevel + 1);
    ...
    code =
        generator.ParseTemplate(tabLevel, "VariableMapXmlLoad", replacements);
  }
...
std::string MetaVariableMap::GetXmlSaveCode(const Generator& generator,
  ...
  if (mKeyElementType && mValueElementType) {
    ...
    replacements["@VAR_XML_VALUE_SAVE_CODE@"] =
        mValueElementType->GetXmlSaveCode(generator, "element", doc, parent,
                                          tabLevel + 1, "value");
    replacements["@PARENT@"] = parent;

    code = generator.ParseTemplate(0, "VariableMapXmlSave", replacements);
  }
...
std::string MetaVariableMap::GetAccessDeclarations(const Generator& generator,
  ...
  if (mKeyElementType && mValueElementType) {
    ...
    ss << generator.ParseTemplate(tabLevel, "VariableMapAccessDeclarations",
                                  replacements)
       << std::endl;
  }
...
std::string MetaVariableMap::GetAccessFunctions(const Generator& generator,
  ...
  if (mKeyElementType && mValueElementType) {
    ...
    ss << std::endl
       << generator.ParseTemplate(0, "VariableMapAccessFunctions", replacements)
       << std::endl;
  }
...
std::string MetaVariableMap::GetUtilityDeclarations(const Generator& generator,
  ...
  if (mKeyElementType && mValueElementType) {
    ...
    ss << generator.ParseTemplate(tabLevel, "VariableMapUtilityDeclarations",
                                  replacements)
       << std::endl;
  }

  if (mValueElementType &&
      mValueElementType->GetMetaType() == MetaVariableType_t::TYPE_ENUM) {
...
std::string MetaVariableMap::GetUtilityFunctions(
  ...
  if (mKeyElementType && mValueElementType) {
    ...
    auto keyValidation =
        mKeyElementType->GetValidCondition(generator, "key", false);
    auto valueValidation =
        mValueElementType->GetValidCondition(generator, "val", false);

    replacements["@KEY_VALIDATION_CODE@"] =
        keyValidation.length() > 0 ? keyValidation
                                   : "([&]() { (void)key; return true; })()";
    replacements["@VALUE_VALIDATION_CODE@"] =
        valueValidation.length() > 0 ? valueValidation
                                     : "([&]() { (void)val; return true; })()";

    ss << std::endl
       << generator.ParseTemplate(0, "VariableMapUtilityFunctions",
                                  replacements)
       << std::endl;
  }
...
std::string MetaVariableMap::GetAccessScriptBindings(const Generator& generator,
  ...
  if (mKeyElementType && mValueElementType) {
    ...
    ss << generator.ParseTemplate(tabLevel, "VariableMapAccessScriptBindings",
                                  replacements)
       << std::endl;
  }
