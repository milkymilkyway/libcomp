...
MetaVariableBool::MetaVariableBool() : MetaVariable(), mDefaultValue(false) {}

MetaVariableBool::~MetaVariableBool() {}

bool MetaVariableBool::GetDefaultValue() const { return mDefaultValue; }

void MetaVariableBool::SetDefaultValue(const bool value) {
  mDefaultValue = value;
}

size_t MetaVariableBool::GetSize() const { return sizeof(bool); }

MetaVariable::MetaVariableType_t MetaVariableBool::GetMetaType() const {
  return MetaVariable::MetaVariableType_t::TYPE_BOOL;
}

std::string MetaVariableBool::GetType() const { return "bool"; }

bool MetaVariableBool::IsCoreType() const { return true; }

bool MetaVariableBool::IsScriptAccessible() const { return true; }

bool MetaVariableBool::IsValid() const { return true; }
...
std::string MetaVariableBool::GetCodeType() const { return GetType(); }
...
std::string MetaVariableBool::GetLoadRawCode(const Generator& generator,
  ...
  code = generator.ParseTemplate(0, "VariableBoolLoad", replacements);
...
std::string MetaVariableBool::GetSaveRawCode(const Generator& generator,
  ...
  code = generator.ParseTemplate(0, "VariableBoolSave", replacements);
...
std::string MetaVariableBool::GetXmlLoadCode(const Generator& generator,
  ...
  return generator.ParseTemplate(tabLevel, "VariableBoolXmlLoad", replacements);
}
...
std::string MetaVariableBool::GetXmlSaveCode(const Generator& generator,
  ...
  return generator.ParseTemplate(tabLevel, "VariableBoolXmlSave", replacements);
}
