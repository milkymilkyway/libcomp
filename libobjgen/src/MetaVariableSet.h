/**
 * @file libobjgen/src/MetaVariableSet.h
 * @ingroup libobjgen
 *
 * @author HACKfrost
 *
...
#ifndef LIBOBJGEN_SRC_METAVARIABLESET_H
#define LIBOBJGEN_SRC_METAVARIABLESET_H
...
class MetaVariableSet : public MetaVariable {
 public:
  MetaVariableSet(const std::shared_ptr<MetaVariable>& elementType);
  virtual ~MetaVariableSet();
...
#endif  // LIBOBJGEN_SRC_METAVARIABLESET_H
