...
Sqrat::s64::s64(int32_t value) { mValue = value; }

Sqrat::s64::s64(const s64& other) { mValue = other.mValue; }
...
void Sqrat::s64::set(int64_t value) { mValue = value; }

int64_t Sqrat::s64::value() const { return mValue; }

int32_t Sqrat::s64::valueTruncated() const { return (int32_t)mValue; }
...
Sqrat::u64::u64() { mValue = 0; }

Sqrat::u64::u64(int32_t value) { mValue = (uint64_t)value; }

Sqrat::u64::u64(const u64& other) { mValue = other.mValue; }
...
void Sqrat::u64::set(uint64_t value) { mValue = value; }

uint64_t Sqrat::u64::value() const { return mValue; }

int32_t Sqrat::u64::valueTruncated() const { return (int32_t)mValue; }
...
static Sqrat::s64 s64_cast(int32_t value) { return Sqrat::s64(value); }

static Sqrat::u64 u64_cast(int32_t value) { return Sqrat::u64(value); }
