...
static inline const BIGNUM *DH_get0_p(const DH *dh) { return dh->p; }

static inline const BIGNUM *DH_get0_q(const DH *dh) { return dh->q; }

static inline const BIGNUM *DH_get0_g(const DH *dh) { return dh->g; }
