...
std::unordered_map<
    std::string, std::function<bool(ScriptEngine&, const std::string& module)>>
    ScriptEngine::mModules;
...
ScriptEngine::~ScriptEngine() { sq_close(mVM); }
...
HSQUIRRELVM ScriptEngine::GetVM() { return mVM; }
...
void ScriptEngine::RegisterModule(
...
void ScriptEngine::InitializeBuiltins() {
  RegisterModule("database",
                 [](ScriptEngine& engine, const std::string& module) -> bool {
                   (void)module;
